...
(local $a i32)(local $b i32)(local $pair_addr i32)(local $old_pair_addr i32)(local $str_ptr i32)(local $closure_ptr i32)(local $__fptr i32)
...
)(data  $linear_memory(offset i32.const 23
) "int")(data  $linear_memory(offset i32.const 21
) "it")(data  $linear_memory(offset i32.const 9
) "(int -> int)")(data  $linear_memory(offset i32.const 8
) "f")(data  $linear_memory(offset i32.const 5
) "int")(data  $linear_memory(offset i32.const 4
) "b")(data  $linear_memory(offset i32.const 1
) "int")(data  $linear_memory(offset i32.const 0
) "a"))