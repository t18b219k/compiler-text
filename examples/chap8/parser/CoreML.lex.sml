    ...
    val tab =
      ...
      in
        Vector.fromList (map g
          ...
          , {fin = [(N 97)], trans = 4}
          , {fin = [(N 90)], trans = 4}
          , {fin = [(N 83), (N 97)], trans = 6}
          , {fin = [(N 83)], trans = 6}
          , {fin = [(N 83), (N 97)], trans = 8}
          , {fin = [(N 83)], trans = 9}
          , {fin = [(N 56), (N 83)], trans = 6}
          , {fin = [(N 83), (N 97)], trans = 11}
          , {fin = [(N 83)], trans = 12}
          , {fin = [(N 83)], trans = 13}
          , {fin = [(N 35), (N 83)], trans = 6}
          , {fin = [(N 83)], trans = 15}
          , {fin = [(N 83)], trans = 16}
          , {fin = [(N 52), (N 83)], trans = 6}
          , {fin = [(N 83), (N 97)], trans = 18}
          , {fin = [(N 83)], trans = 19}
          , {fin = [(N 18), (N 83)], trans = 6}
          , {fin = [(N 83), (N 97)], trans = 21}
          , {fin = [(N 83)], trans = 22}
          , {fin = [(N 14), (N 83)], trans = 6}
          , {fin = [(N 83), (N 97)], trans = 24}
          , {fin = [(N 47), (N 83)], trans = 6}
          , {fin = [(N 83), (N 97)], trans = 26}
          , {fin = [(N 83)], trans = 27}
          , {fin = [(N 60), (N 83)], trans = 6}
          , {fin = [(N 44), (N 83)], trans = 6}
          , {fin = [(N 83)], trans = 30}
          , {fin = [(N 83)], trans = 31}
          , {fin = [(N 83)], trans = 32}
          , {fin = [(N 41), (N 83)], trans = 6}
          , {fin = [(N 83), (N 97)], trans = 34}
          ...
          , {fin = [(N 83), (N 97)], trans = 42}
          , {fin = [(N 83)], trans = 43}
          , {fin = [(N 10), (N 83)], trans = 6}
          , {fin = [(N 70), (N 97)], trans = 45}
          , {fin = [(N 73)], trans = 0}
          , {fin = [(N 68), (N 97)], trans = 0}
          , {fin = [(N 86), (N 97)], trans = 48}
          , {fin = [(N 86)], trans = 48}
          ...
          , {fin = [], trans = 56}
          , {fin = [(N 95)], trans = 0}
          , {fin = [(N 6), (N 97)], trans = 0}
          , {fin = [(N 6), (N 97)], trans = 60}
          , {fin = [(N 6)], trans = 0}
          ])
      end
                          ...
                          (let
                           ...
                           in
                             ...
                             ; case yyk of
                               ...
                               | 35 => (Tokens.TRUE (yypos, yypos + 4))
                               | 41 => (Tokens.FALSE (yypos, yypos + 5))
                               | 44 => (Tokens.FN (yypos, yypos + 2))
                               | 47 => (Tokens.IF (yypos, yypos + 2))
                               | 52 => (Tokens.THEN (yypos, yypos + 4))
                               | 56 => (Tokens.VAL (yypos, yypos + 3))
                               | 6 => (lex ())
                               | 60 => (Tokens.FUN (yypos, yypos + 3))
                               ...
                               | 70 => (Tokens.EQUAL (yypos, yypos + 1))
                               | 73 => (Tokens.DARROW (yypos, yypos + 2))
                               ...
                               | 97 =>
                                   ...
                                   in Tokens.ID (yytext, yypos, yypos + 1)
                                   end
              ...
              in
                if l = !yybl then
                  if trans = #trans (Vector.sub (Internal.tab, 0)) then
                    ...
                    in
                      if (size newchars) = 0 then
                        ( yydone := true
                        ; if (l = i0) then UserDeclarations.eof ()
                          else action (l, NewAcceptingLeaves)
                        )
                      else
                        ( if i0 = l then yyb := newchars
