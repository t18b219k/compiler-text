...
struct
  ...
  *)
  ...
  val internal_local_vars = [
    (I.local_(SOME(IDX.localidx(IDX.text_id("pair_addr"))),I.i32)),
    (I.local_(SOME(IDX.localidx(IDX.text_id("closure_ptr"))),I.i32)),
    (I.local_(SOME(IDX.localidx(IDX.text_id("__fptr"))),I.i32))]
  (*型付き抽象構文木の自由変数を求める*)
  fun fv e=case e of 
    TS.INT(_)=>SEnv.empty
    |TS.TRUE=>SEnv.empty
